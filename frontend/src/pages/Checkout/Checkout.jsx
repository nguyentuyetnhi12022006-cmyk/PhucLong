        ...
        <div className="container success-container">
          <div className="success-card">
            ...
            <div className="success-actions">
              <Link
                to={user ? `/profile?tab=track&id=${createdOrder._id}` : `/tracking?id=${createdOrder._id}&phone=${encodeURIComponent(createdOrder.customerPhone || '')}`}
                className="btn btn-primary btn-track-order-success"
              >
